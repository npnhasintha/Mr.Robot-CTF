...
<div id="mySidebar" class="sidebar">
  ...
  <a href="./level9.php" class="active">Level 9</a>
...
<div class="overlay"></div>
                ...
                <div class="hint-banner">
                    ...
                    <div id="instruction">
                        <p>Elliot found pickledump while recovering data from harddisk, extracts the flag from that pickledump</p>
                        <center><a style="font-size:1.2em; background-color:lightgoldenrodyellow; padding: 6px; border:2px solid red; border-radius: 5px;"
                            href="../assets/flags/pickleDump/pickle.zip" download="pickle_dump">Download</a></center>
    ...
    <div class="container">
        ...
        <div class="flag">
           ...
           <form name="flag" action="" method="post" onsubmit="return validateForm()">
            ...
            <div class="row">
                <input type="hidden" value="<?php echo 9 ?>" name="flagid" id="flagid">
                <input type="hidden" value="<?php echo 9 ?>" name="levelid" id="levelid">
