...
<div id="mySidebar" class="sidebar">
  ...
  <a href="./level3.php" class="active">Level 3</a>
...
<div class="flag">
   ...
   <form name="flag" action="" method="post" onsubmit="return validateForm()">
    ...
    <div class="row">
        <input type="hidden" value="<?php echo 3 ?>" name="flagid" id="flagid">
        <input type="hidden" value="<?php echo 3 ?>" name="levelid" id="levelid">
