...
<div id="mySidebar" class="sidebar">
  ...
  <a href="./level7.php" class="active">Level 7</a>
    ...
    <div class="container">
        ...
        <div class="flag">
           ...
           <form name="flag" action="" method="post" onsubmit="return validateForm()">
            ...
            <div class="row">
                <input type="hidden" value="<?php echo 7 ?>" name="flagid" id="flagid">
                <input type="hidden" value="<?php echo 7 ?>" name="levelid" id="levelid">
