...
<div id="mySidebar" class="sidebar">
  ...
  <a href="./level2.php" class="active">Level 2</a>
...
<div class="overlay"></div>
                ...
                <div class="hint-banner">
                    ...
                    <div id="instruction">
                        <p>Darline wanted to meet Mr.Robot. so she tried to find the secret fsociety using google but google couldn't. Wish you luck!...</p>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="flag">
           ...
           <form name="flag" action="" method="post" onsubmit="return validateForm()">
            ...
            <div class="row">
                <input type="hidden" value="<?php echo 2 ?>" name="flagid" id="flagid">
                <input type="hidden" value="<?php echo 2 ?>" name="levelid" id="levelid">
