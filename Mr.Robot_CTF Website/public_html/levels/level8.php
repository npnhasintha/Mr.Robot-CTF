...
<div id="mySidebar" class="sidebar">
  ...
  <a href="./level8.php" class="active">Level 8</a>
...
<div class="overlay"></div>
                ...
                <div class="hint-banner">
                    ...
                    <div id="instruction">
		                        <p>You have to do some <b>Injections</b> to see the Flag...</p>
                        <p>Follow this <a href="../assets/flags/sqlInj_page/sqlInj/sqlInj.php" target="_blank">link</a></p>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="flag">
           ...
           <form name="flag" action="" method="post" onsubmit="return validateForm()">
            ...
            <div class="row">
                <input type="hidden" value="<?php echo 8 ?>" name="flagid" id="flagid">
                <input type="hidden" value="<?php echo 8 ?>" name="levelid" id="levelid">
