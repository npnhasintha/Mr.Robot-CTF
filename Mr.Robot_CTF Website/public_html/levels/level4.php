...
<div id="mySidebar" class="sidebar">
  ...
  <a href="./level4.php" class="active">Level 4</a>
...
<div class="overlay"></div>
                ...
                <div class="hint-banner">
                    ...
                    <div id="instruction">
                        <p>Do previous level and get Credentials...</p>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="flag">
           ...
           <form name="flag" action="" method="post" onsubmit="return validateForm()">
            ...
            <div class="row">
                <input type="hidden" value="<?php echo 4 ?>" name="flagid" id="flagid">
                <input type="hidden" value="<?php echo 4 ?>" name="levelid" id="levelid">
