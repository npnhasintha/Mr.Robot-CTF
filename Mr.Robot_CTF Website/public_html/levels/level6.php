...
<div id="mySidebar" class="sidebar">
  ...
  <a href="./level6.php" class="active">Level 6</a>
...
<div class="overlay"></div>
                ...
                <div class="hint-banner">
                    ...
                    <div id="instruction">
			<p>Elliot found a sound clip contain a secret message, Now you have to examine the sound clip and find out the flag </p>
                        <center><a style="font-size:1.2em; background-color:lightgoldenrodyellow; padding: 6px; border:2px solid red; border-radius: 5px;"
                            href="../assets/flags/audio/flag.wav" download="audio_flag_mrrobot">Download</a></center>
    ...
    <div class="container">
        ...
        <div class="flag">
           ...
           <form name="flag" action="" method="post" onsubmit="return validateForm()">
            ...
            <div class="row">
                <input type="hidden" value="<?php echo 6 ?>" name="flagid" id="flagid">
                <input type="hidden" value="<?php echo 6 ?>" name="levelid" id="levelid">
